                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title text-danger">Pengumuman proses belajar mengajar...</h5>
                                    <p>Mahasiswa yang diterima menjadi asisten dosen dapat segera melakukan konfirmasi
                                        ke dosen pengampu matakuliah.</p>

                                        <ul class="list-group mb-2">
                                          <li class="list-group-item d-flex justify-content-between align-items-center">
                                            1. Perkuliahan Tahap 1
                                            <span class="badge bg-label-warning rounded-pill">25 September 2024</span>
                                          </li>
                                          <li class="list-group-item d-flex justify-content-between align-items-center">
                                            2. Ujian Tengah Semester
                                            <span class="badge bg-label-warning rounded-pill">13 November 2024</span>
                                          </li>
                                          <li class="list-group-item d-flex justify-content-between align-items-center">
                                            3. Perkuliahan Tahap 2
                                            <span class="badge bg-label-warning rounded-pill">27 November 2024</span>
                                          </li>
                                          <li class="list-group-item d-flex justify-content-between align-items-center">
                                            4. Ujian Akhir Semester
                                            <span class="badge bg-label-warning rounded-pill">15 Januari 2025</span>
                                          </li>
                                        </ul>
